        ...
        <tr key={index}>
          ...
          <td>
            <button
              ...
              onClick={() => handleTangGiamSL(sp.id, false)}
            >
              -
            </button>
            {sp.soLuong}
            <button
              ...
              onClick={() => handleTangGiamSL(sp.id, true)}
            >
              +
            </button>
          </td>
